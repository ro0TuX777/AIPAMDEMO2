...
def jobresult_to_markdown(result: JobResult) -> str:
    ...
    lines.append(f"Classification: **{result.summary.classification}**")
    lines.append("## Key Findings")
    for f in result.summary.key_findings:
        lines.append(f"- {f}")
    lines.append("")
    
    # ENHANCEMENT: Add detailed anomalies section to Markdown
    # Fix: Access chunks via llm_analysis_raw
