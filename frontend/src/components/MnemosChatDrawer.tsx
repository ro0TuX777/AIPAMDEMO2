...
export function MnemosChatDrawer({
  ...
  return (
    <aside aria-label="MNEMOS comparison" className="fixed inset-y-0 right-0 z-40 flex w-full max-w-lg flex-col border-l border-slate-700 bg-slate-950 shadow-2xl md:static md:h-full md:w-[28rem] md:rounded-lg md:border">
